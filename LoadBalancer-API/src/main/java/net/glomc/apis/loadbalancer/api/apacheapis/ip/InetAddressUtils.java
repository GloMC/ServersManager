...
// exact copy from https://github.com/apache/httpcomponents-client/blob/4.5.x/httpclient/src/main/java/org/apache/http/conn/util/InetAddressUtils.java
package net.glomc.apis.loadbalancer.api.apacheapis.ip;
